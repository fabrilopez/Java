...
<body>
    <form:form method="POST" modelAttribute="obrasocial" action="newobrasocial.html" commandName="obrasocial">
		...
		<a href="<%=request.getContextPath()%>/forms/obras.html" class="button"><span>Volver</span></a>
